...
#ifndef BOOST_CHECKDIGIT_WEIGHT_HPP
#define BOOST_CHECKDIGIT_WEIGHT_HPP
...
/*! \def BOOST_CHECKDIGIT_LIMIT_WEIGHTS
    \brief The BOOST_CHECKDIGIT_LIMIT_WEIGHTS macro defines the maximum number of weights accepted by the library.
...
*/
#define BOOST_CHECKDIGIT_LIMIT_WEIGHTS 100

namespace boost{
  namespace checkdigit{

/*! \class weight
    \brief The weight metafunction encapsulate 0 to BOOST_CHECKDIGIT_LIMIT_WEIGHTS weights.
    ...
    \remarks There are BOOST_CHECKDIGIT_LIMIT_WEIGHTS partial specialisations of this class.
*/
template <BOOST_PP_ENUM_BINARY_PARAMS(BOOST_CHECKDIGIT_LIMIT_WEIGHTS, size_t weight_value, = 0 BOOST_PP_INTERCEPT) >
struct weight
{
...
// Develop the macro _WEIGHT_factory BOOST_CHECKDIGIT_LIMIT_WEIGHTS times.
BOOST_PP_REPEAT_FROM_TO(1,BOOST_CHECKDIGIT_LIMIT_WEIGHTS,_WEIGHT_factory,~)
#undef _WEIGHT_factory

}} // namespace boost   namespace checkdigit

#endif //BOOST_CHECKDIGIT_WEIGHT_HPP
